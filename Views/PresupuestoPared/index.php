...
$formularioHTML = '<form id="formularioDatos" method="post" action="http://localhost/constructora/Views/Historial/historialPared.php">';
//bucle de los datos
...
<div class="card">
    ...
    Presupuesto de Materiales que van en el Pared
    </div>
