...
$tablaHTML = '<div class="card-body pt-0 pb-0">   
...
$formularioHTML = '<form id="formularioDatos" method="post" action="http://localhost/constructora/Views/Historial/historialTecho.php">';
  //bucle de los datos
...
<div class="card">
    ...
    Presupuesto de Materiales que van en los Techos
    </div>
...
<?php endif; $message = isset($_GET['message']) ? $_GET['message'] : "";
