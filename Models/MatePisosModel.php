...
class MatePisosModel extends Query
{
    ...
    {
        $sql = "SELECT m.*, e.nombre as id_elemento, u.id as id_medida, u.medida FROM materiales m INNER JOIN elementos e INNER JOIN medidas u WHERE e.id_elemento=m.id_elemento and u.id = m.id_medida and m.id_elemento=1 and m.estado = 1";
        $data = $this->selectAll($sql);
        return $data;
    }
    ...
    public function getMatePisosInac()
    {
        $sql = "SELECT m.*, e.nombre as id_elemento, u.id as id_medida, u.medida FROM materiales m INNER JOIN elementos e INNER JOIN medidas u WHERE e.id_elemento=m.id_elemento and u.id = m.id_medida and m.id_elemento=1 and m.estado = 0";
        $data = $this->selectAll($sql);
        return $data;
    }
